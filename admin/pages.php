        ...
        <table class="table table-bordered" style="text-align:center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td ><?php echo htmlspecialchars($row['page_type']); ?></td>
              <td id="example" style="text-align:left"><div style="width:100%; max-height:110px; overflow:auto"><?php echo htmlspecialchars($row['page_data']); ?></div></td>
      ...
      <div class="table-responsive" style="text-align:center;align:center">
        ...
        if(mysqli_num_rows($result1) > 0){
          ...
          for($i = 1; $i <= $total_page; $i++){
            ...
            echo '<li class="'.$active.'"><a href="pages.php?page='.$i.'